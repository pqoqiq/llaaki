...
if foo:
	...
	cobe="#Decoded By Hso AND Levi: @sis_f  On: @Q_B_H \n\n"
	source=cobe+source+'\n'+cobe
	#source=source.split('        ')
	#source=''.join(source)
...
Force_subsck=[]
tok='6323286487:AAGH1DPoGYmI-obbGxdf4XnCzBN7IGDtshw'
#tok='6298268234:AAGewQWMDuHdL-wU2RTS84D0ZXbWFVFRQJ0'
bot=TeleBot(tok)
admin=['6642066070','6642066070']
import sys,os
cu=(os.getcwd())
...
layrs=0
channel=['SUAKKEYVIP']
groups=['SUAKKEYVIP']#https://t.me/SUAKKEYVIP
def als(om,m):
	xs='قفل البوت'
	mx='تفعيل'
	if xs in om:
	...
	if om:
		try:
			error_msg='عذرا البوت لٱ يعمل الى ان كان صاحب بوت في مجموعة قم بمراسلة/@ppsau'
